...
const Camp = () => {
  return (
    <section className="mt-16 sm:mt-40 md:mt-16 xl:mt-0 2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
...
const CampSite = ({
  ...
  return (
    <div
      className={`h-full w-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat md:rounded-r-5xl xl:rounded-5xl xl:ml-7`}
    >
